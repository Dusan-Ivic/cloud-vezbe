...
namespace TransactionCoordinator
{
    public class WorkerRole : RoleEntryPoint
    {
        ...
        private TransactionCoordinatorServer transactionCoordinatorServer = new TransactionCoordinatorServer();
        ...
        public override bool OnStart()
        {
            ...
            transactionCoordinatorServer.Open();
        ...
        public override void OnStop()
        {
            ...
            base.OnStop();
            transactionCoordinatorServer.Close();
